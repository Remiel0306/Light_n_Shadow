...
mcp.stdout.on('data', (data) => {
    ...
    for (const line of lines) {
        ...
        try {
            ...
            if (res.id === 1) send('tools/call', { name: 'blueprint', arguments: { action: 'read', path: '/Game/BluePrint/BP_EnemyShadowLogic', assetPath: '/Game/BluePrint/BP_EnemyShadowLogic', blueprintPath: '/Game/BluePrint/BP_EnemyShadowLogic' } });
