...
const PY = "D:/Unreal Engine/Light_n_Shadow/fix_steer_preserve_forward.py";
...
(async () => {
  await rpc("initialize", { protocolVersion: "2024-11-05", capabilities: {}, clientInfo: { name: "steer-fix" } });
